  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Hero Section */}
        <section id="home" className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-32 overflow-hidden">
          <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-16">
            <h1 className="text-5xl sm:text-[4.5rem] md:text-[6.5rem] font-serif tracking-tight leading-[1.1] mb-6 md:mb-8">
              <StrobeText text="TRADE" className="text-accent" delay={0.2} /> <StrobeText text="ON YOUR" className="text-white" delay={0.5} />
              <br />
              <StrobeText text="OWN" className="text-accent" delay={1.0} /> <StrobeText text="TERMS" className="text-white" delay={1.3} />
            </h1>
            ...
            >
              ...
              <Link to="/free-trial" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full px-8 h-[52px] rounded-full border border-white text-white hover:bg-white/10 font-medium bg-black/20 backdrop-blur-sm">
                  Free Trial
                </Button>
              </Link>
            </motion.div>
          ...
          <div className="absolute bottom-10 left-0 right-0 z-10 overflow-hidden flex py-4 border-y border-white/5 bg-background/50 backdrop-blur-sm">
            ...
            >
              {[
                { sym: 'NIFTY 50', price: '24,812.30', dir: 'up', chg: '+0.64%' },
                { sym: 'SENSEX', price: '81,547.15', dir: 'up', chg: '+0.58%' },
                { sym: 'BANKNIFTY', price: '52,304.80', dir: 'down', chg: '-0.21%' },
                { sym: 'RELIANCE', price: '2,981.40', dir: 'up', chg: '+1.12%' },
                { sym: 'TCS', price: '3,845.60', dir: 'down', chg: '-0.34%' },
                { sym: 'HDFCBANK', price: '1,672.25', dir: 'up', chg: '+0.87%' },
                { sym: 'INFY', price: '1,504.90', dir: 'down', chg: '-0.12%' },
                { sym: 'ICICIBANK', price: '1,238.55', dir: 'up', chg: '+0.46%' }
              ].map((t, i) => (
                <span key={i} className="flex items-center space-x-2">
                  <strong className="text-white">{t.sym}</strong>
                  <span className={t.dir === 'up' ? "text-primary" : "text-red-500"}>
        ...
        {/* Stats Section */}
        <section id="stats" className="py-16 relative bg-white/5 backdrop-blur-sm border-b border-white/5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 divide-x divide-white/10 text-center">
              {[
                ...
                <div key={i} className="px-2 md:px-4">
                  <div className="text-3xl md:text-5xl font-serif text-primary font-medium mb-2 md:mb-3">{stat.num}</div>
                  <div className="text-[10px] md:text-xs uppercase tracking-widest text-gray-400 font-mono leading-tight">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="method" className="py-24 relative border-b border-white/5">
          <div className="max-w-7xl mx-auto px-4">
            <div className="mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-bold max-w-2xl">Four pillars. One repeatable process for reading any market.</h2>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
                  EMPOWERING <span className="text-gray-400 font-light">THE NEXT GENERATION OF</span> <span className="text-accent">TRADERS</span>
                </h2>
                ...
                <div className="space-y-8 relative pl-8 border-l border-white/10">
                  <div className="relative">
                    ...
                    <p className="text-gray-400">To empower aspiring traders with practical knowledge and confidence to make informed trading decisions.</p>
                  </div>
                  <div className="relative mt-8">
                    ...
                    <p className="text-gray-400">To become one of the most trusted trading education institutes by delivering high-quality learning experiences and measurable student success.</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <img src="/about_trading.png" alt="Trading Session" className="w-full h-full object-cover opacity-90 hover:scale-105 transition-transform duration-700" />
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section id="gallery" className="py-24 relative overflow-hidden bg-black/40 border-b border-white/5 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4">
            <div className="mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-bold max-w-2xl">Less webinar, more trading floor.</h2>
              <p className="text-gray-400 mt-4 max-w-md">Cohorts meet live. Screens stay open. This is what a session actually looks like.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { title: "Live chart walkthroughs", img: "/chart_walkthroughs.png", span: "lg:col-span-2", aspect: "aspect-[21/9]" },
                { title: "Dashboard & screener setup", img: "/dashboard_screener.png", span: "lg:col-span-2", aspect: "aspect-[21/9]" },
                { title: "Momentum & signal drills", img: "/dashboard_screener.png", span: "lg:col-span-2", aspect: "aspect-[21/9]" },
                { title: "Paired trade review", img: "/paired_review.png", span: "lg:col-span-2", aspect: "aspect-[21/9]" },
              ].map((item, i) => (
                <div key={i} className={`relative rounded-2xl overflow-hidden group border border-white/10 ${item.span} ${item.aspect}`}>
                  <img src={item.img} alt={item.title} className="w-full h-full object-cover opacity-70 group-hover:scale-105 group-hover:opacity-100 transition-all duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent pointer-events-none" />
                  <span className="absolute bottom-6 left-6 font-mono text-xs tracking-widest uppercase text-gray-300 z-10">{item.title}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="results" className="py-24 relative overflow-hidden border-b border-white/5">
          ...
          <div className="relative w-full overflow-hidden flex flex-col gap-6 py-4">
            {[
              [
                { q: "The order block concepts in SMC stopped me from chasing every breakout. That alone paid for the course.", n: "Karan V.", r: "SMC" },
                { q: "First time a trading course actually explained when to exit, not just when to enter.", n: "Meera S.", r: "Risk Management" },
                { q: "The live desk sessions inside SMC are worth it alone — watching a trade plan happen in real time.", n: "Aditya R.", r: "SMC" },
                { q: "I finally have a written process I follow instead of reacting to every candle.", n: "Simran K.", r: "Price Action" },
              ],
              [
                { q: "Price Action made chart reading click in a way three YouTube channels never did.", n: "Farhan A.", r: "Price Action" },
                { q: "Risk Management changed my position sizing completely. Fewer, better trades now.", n: "Neha J.", r: "Risk Management" },
                { q: "The Psychology of Market module fixed more of my trading than any strategy course did.", n: "Vikram T.", r: "Psychology of Market" },
                { q: "MSNR is dense, but it's the first advanced course that didn't feel like recycled basics.", n: "Ananya D.", r: "Advanced Concept (MSNR)" }
              ]
            ].map((row, i) => (
              <motion.div
                key={i}
              ...
              >
                {[...row, ...row].map((t, j) => (
                  <GlassCard key={j} className="w-[85vw] md:w-[420px] p-6 md:p-8 bg-white/5 border-white/10 shrink-0 shadow-lg flex flex-col justify-between whitespace-normal">
                    <p className="font-serif italic text-base md:text-lg leading-relaxed text-gray-200 mb-6 md:mb-8">"{t.q}"</p>
                    <div className="font-mono text-xs tracking-widest uppercase text-gray-400 mt-auto">
                      {t.n} · <span className="text-primary font-bold">{t.r}</span>
                    </div>
                  </GlassCard>
                ))}
              </motion.div>
        ...
        <section id="team" className="py-24 relative">
          <div className="max-w-7xl mx-auto px-4 overflow-hidden">
            <h2 className="text-3xl font-bold mb-12 text-center">Meet Our <span className="text-primary">Team</span></h2>

            <h3 className="text-xl font-semibold mb-6 text-gray-400 border-b border-white/10 pb-2">Teaching Mentors</h3>
              ...
              {[1, 2].map((i) => (
                <GlassCard key={i} className="flex items-center space-x-6">
                  <div className="w-24 h-24 rounded-full bg-white/10 flex-shrink-0 border-2 border-primary/50 overflow-hidden">
                    <img src={`https://i.pravatar.cc/150?img=${i + 10}`} alt="Mentor" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <h4 className="text-xl font-bold">Rahul Sharma</h4>
                    <p className="text-primary text-sm mb-2">Senior Trading Mentor</p>
                    <p className="text-gray-400 text-xs">Such a good vibe got from this Coaching experience I have got from this Coaching. Helping students since 2018.</p>
                  </div>
                </GlassCard>
              ))}
            </div>

            <h3 className="text-xl font-semibold mb-6 text-gray-400 border-b border-white/10 pb-2">Technical Team</h3>
              ...
              {[1, 2, 3, 4].map((i) => (
                <GlassCard key={i} className="text-center p-4">
                  <div className="w-20 h-20 rounded-full bg-white/10 mx-auto mb-4 border border-white/20 overflow-hidden">
                    <img src={`https://i.pravatar.cc/150?img=${i + 20}`} alt="Tech Member" className="w-full h-full object-cover" />
                  </div>
        ...
        <section id="faq" className="py-24 relative border-t border-white/10">
          <div className="max-w-3xl mx-auto px-4">
            <div className="text-center mb-16">
              <span className="text-primary font-mono text-sm tracking-widest uppercase mb-4 block">Questions</span>
              <h2 className="text-3xl md:text-5xl font-bold">Before you start.</h2>
            </div>

            <div className="space-y-2">
              {[
                { q: "Do I need any trading experience to start?", a: "No. Price Action assumes zero experience and builds up from how to read a candle to your first rules-based trade plan." },
                { q: "Which markets does the T4 Method apply to?", a: "The framework is built and taught using NSE and BSE equity and derivatives examples, but the same four-pillar process applies to any liquid market." },
                { q: "Is this financial advice?", a: "No. T4 Traders provides trading education only. Trading involves risk, and nothing taught in these courses guarantees profit." },
                { q: "Can I upgrade to a higher track later?", a: "Yes — most students start with Price Action and add SMC, Risk Management, or the Advanced Concept course once they've decided trading is worth the deeper commitment." },
                { q: "How do live sessions work?", a: "Live sessions run three times a week during market hours, streamed to the student portal, with recordings available within an hour for anyone who misses one." }
              ].map((faq, i) => (
                <details key={i} className="group border-b border-white/10 [&_summary::-webkit-details-marker]:hidden cursor-pointer bg-white/5 rounded-lg px-6">
                  <summary className="flex items-center justify-between py-6 text-lg font-medium outline-none">
                    ...
                    <span className="relative ml-4 shrink-0 transition duration-300 group-open:-rotate-180 text-primary">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
